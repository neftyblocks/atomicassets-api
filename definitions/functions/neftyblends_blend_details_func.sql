...
FROM neftyblends_blends blend
         ...
         LEFT JOIN(SELECT ing_attribute.contract,
                   ...
                   GROUP BY ing_attribute.contract, ing_attribute.blend_id,
         ...
         LEFT JOIN(SELECT roll.contract,
                          roll.blend_id,
                          roll.roll_index,
                   ...
                   FROM neftyblends_blend_rolls roll
                            LEFT JOIN (SELECT outcome.contract,
                                              outcome.blend_id,
                                              outcome.roll_index,
         ...
         LEFT JOIN(SELECT upg_spec.contract,
                   ...
                   FROM neftyblends_blend_upgrade_specs upg_spec
                            LEFT JOIN (SELECT upg_req.contract,
                                       ...
                                       FROM neftyblends_blend_upgrade_spec_upgrade_requirements upg_req) AS upg_req_sub
                                      ON
                            ...
                            LEFT JOIN (SELECT upg_res.contract,
                                       ...
                                       FROM neftyblends_blend_upgrade_spec_upgrade_results upg_res) AS upg_res_sub ON
                   ...
                   GROUP BY upg_spec.contract, upg_spec.blend_id, upg_spec.upgrade_spec_index,
                            upg_spec.schema_name, upg_spec.display_data) as upg_spec_sub ON
